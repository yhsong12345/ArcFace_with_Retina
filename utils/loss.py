...
#     def __init__(self, embedding_size=512, num_classes=2, s=64, m=.5):
#         super(ArcFace, self).__init__()

#         self.embedding = embedding_size
#         self.num_classes = num_classes
#         self.weight = nn.Parameter(torch.FloatTensor(self.embedding, self.num_classes))
...
#         cos_theta = torch.mm(embeddings, weight_norm)
